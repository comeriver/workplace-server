...
class Workplace_Workspace_List extends Workplace_Workspace_Abstract
{
    ...
    protected function createList()
    {
        $listX = 			
        array(
            array( 'field' => 'name', 'value' =>  '<a style="font-size:smaller;"  onClick="ayoola.spotLight.showLinkInIFrame( \'' . Ayoola_Application::getUrlPrefix() . '/tools/classplayer/get/object_name/Workplace_Workspace_Insights/?' . $this->getIdColumn() . '=%KEY%\', \'' . $this->getObjectName() . '\' );" href="javascript:">%FIELD%</a>', 'filter' =>  '' ),                     
