		...
		(
			array(
                //    'user_id' => array( 'field' => 'user_id', 'value' =>  '%FIELD%', 'filter' =>  '' ),                     
                    ...
                    array( 'field' => 'workspace_id', 'value' =>  '<a style="font-size:smaller;" rel="shadowbox;changeElementId=' . $this->getObjectName() . '" href="' . Ayoola_Application::getUrlPrefix() . '/tools/classplayer/get/object_name/Workplace_Workspace_messenger/?' . $this->getIdColumn() . '=%KEY%">Message workspace_user</a>' ), 
