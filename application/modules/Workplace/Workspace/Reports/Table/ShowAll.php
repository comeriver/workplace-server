...
class Workplace_Workspace_Reports_Table_ShowAll extends Workplace_Workspace_Reports_Table_Abstract
{
    ...
    public function init()
    {
        ...
        <div class="pc_give_space_top_bottom"> 
            <a class="btn btn-primary" href="' . Ayoola_Application::getUrlPrefix() . '/tools/classplayer/get/name/Workplace_Workspace_Reports/?workspace_id=' . $data['workspace_id'] . '"><i class="fa fa-chevron-right pc_give_space ' .  "\r\n" . '"></i>' . self::__( 'Create a report' ) . '<i class="fa fa-bar-chart pc_give_space ' .  "\r\n" . '"></i></a>
        </div>'  ); 
            ...
            <div>
                <div class="xwk-50" >
                    <p class="pc_give_space_top_bottom section-divider">
                        ...
                        <a style="margin:1em;" href="javascript:" onClick="ayoola.spotLight.showLinkInIFrame( \'' . Ayoola_Application::getUrlPrefix() . '/tools/classplayer/get/name/Workplace_Workspace_Reports_Table_Delete/?table_id=' . $report['table_id'] . '\', \'' . $this->getObjectName() . '\' );"><i class="fa fa-trash" aria-hidden="true"></i></a>
                        <a style="margin:1em;" href="javascript:" onClick="ayoola.spotLight.showLinkInIFrame( \'' . Ayoola_Application::getUrlPrefix() . '/tools/classplayer/get/name/Workplace_Workspace_Reports/?workspace_id=' . $report['workspace_id'] . '&table_id=' . $report['table_id'] . '\', \'' . $this->getObjectName() . '\' );"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
